...
class Train_DNN:
    ...
    def preTraining(self, inputX, targetsY):
        ...
        self.autoencoder_A.fit(inputX, targetsY, epochs=10000, batch_size=100, callbacks=callbacks_list1, validation_split=0.1)
        self.autoencoder_B.fit(inputX, targetsY, epochs=10000, batch_size=100, callbacks=callbacks_list2, validation_split=0.1)
