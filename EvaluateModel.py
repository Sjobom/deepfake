...
class EvaluateModel():
    def __init__(self, epochs = 999):
        self.autoencoder_A = load_model('./model/autoencoderA_specialized_e' + str(epochs) + '.hdf5')
        self.autoencoder_B = load_model('./model/autoencoderB_specialized_e' + str(epochs) + '.hdf5')
