...
class Masked_Converter():
    def __init__(self, encoder, blur_size=2, seamless_clone=False, mask_type="facehullandrect", erosion_kernel_size=None, match_histogram=False, sharpen_image=None, **kwargs):
    ...
    def get_new_face(self, image, mat, size):
        ...
        new_face = self.encoder.evaluate_B(normalized_face)[0]
